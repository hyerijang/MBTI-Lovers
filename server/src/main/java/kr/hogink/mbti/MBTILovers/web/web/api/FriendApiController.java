...
public class FriendApiController {
    ...
    // 친구 수락
    @PutMapping("/api/friends/{uid}/acceptRequest/{fid}")
    public String accept(@PathVariable String uid, @PathVariable String fid) {
        Friend friend = friendService.getFriend(uid, fid);
